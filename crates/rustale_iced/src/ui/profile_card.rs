...
pub fn view<'a>(
            ...
            dropdown_content = dropdown_content.push(
                container(
                    row![
                        ...
                        theme::magic_button(
                            button(theme::svg(
                                svg(util::svg_handle(util::icons::CHECK))
                                    .width(12)
                                    .height(12)
                        ...
                        theme::magic_button(
                            button(theme::svg(
                                svg(util::svg_handle(util::icons::X))
                                    .width(12)
                                    .height(12)
                                    .style(move |t, s| theme::svg_accent(&palette, t, s)),
                                ctx
                    ...
                    vec![
                        theme::magic_tooltip(
                            tooltip(
                                theme::magic_button(
                                    button(theme::svg(
                                        svg(util::svg_handle(util::icons::COPY))
                                            .width(12)
                                            .height(12)
                                            .style(move |t, s| theme::svg_accent(&palette, t, s))
                        ...
                        theme::magic_tooltip(
                            tooltip(
                                theme::magic_button(
                                    button(theme::svg(
                                        svg(util::svg_handle(util::icons::DICE))
                                            .width(12)
                                            .height(12)
                                            .style(move |t, s| theme::svg_accent(&palette, t, s))
                                            .opacity(ctx.palette.text_primary.a),
                ...
                button(
                    row![
                        ...
                        tooltip(
                            theme::magic_button(
                                button(theme::svg(
                                    svg(util::svg_handle(util::icons::PERSON))
                                        .width(12)
                                        .height(12)
                                        .style(move |t, s| theme::svg_accent(&palette, t, s))
                                        .opacity(ctx.palette.text_primary.a),
                        ...
                        theme::magic_button(
                            button(theme::svg(
                                svg(util::svg_handle(util::icons::EDIT))
                                    .width(12)
                                    .height(12)
                                    .style(move |t, s| theme::svg_accent(&palette, t, s))
                                    .opacity(ctx.palette.text_primary.a),
    ...
    let add_button_inner = iced::widget::row![
        theme::svg(
            svg(util::svg_handle(util::icons::PLUS))
                .width(14)
                .height(14)
                .opacity(ctx.palette.text_primary.a),
            ctx,
            ...
            theme::magic_button(
                button(
                    row![
                        ...
                        theme::svg(
                            svg(util::svg_handle(if dropdown_open {
                                util::icons::X
                            } else {
